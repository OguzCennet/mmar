...
relations = ['None', 'ID1', 'NI', 'BR1', 'BR2', 'BR3']
...
def get_de_recipe_data():
	de_train_mmar_files = '/netscratch/oguz/impress/mmar/md_ar/github/datasets/de_train'
	de_test_mmar_files = '/netscratch/oguz/impress/mmar/md_ar/github/datasets/de_test'
	
	out = {}
	out['train'] = {}
	train_files = [file for file in glob.glob(de_train_mmar_files+'/*', recursive = True)]
	train_out, train_unique_words = parser(train_files)
	out['train'] = train_out
	out['train_unique_words'] = train_unique_words

	out['test'] = {}
	test_files = [file for file in glob.glob(de_test_mmar_files+'/*', recursive = True)]
